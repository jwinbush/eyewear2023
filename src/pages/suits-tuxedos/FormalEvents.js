...
const list = [
  ...
  {
    id: 16,
    title: "Hampton Tartan Navy Tuxedo",
    imageSrc:
      "https://i8.amplience.net/i/indochino/15014819_0_0.webp?w=312&sm=aspect&aspect=0.5693430656934306:1&qlt=100",
    link: "/suits-tuxedos/new",
  },
  {
    id: 17,
    title: "Harford Velvet Brown Tuxedo",
    imageSrc:
      "https://i8.amplience.net/i/indochino/15013694_0_0.webp?w=312&sm=aspect&aspect=0.5693430656934306:1&qlt=100",
    link: "/suits-tuxedos/business",
  },
  {
    id: 18,
    title: "Harford Velvet Burgundy Tuxedo",
    imageSrc:
      "https://i8.amplience.net/i/indochino/15011979_0_0.webp?w=312&sm=aspect&aspect=0.5693430656934306:1&qlt=100",
    link: "/suits-tuxedos/tuxedo",
  },
  {
    id: 19,
    title: "Harford Velvet Emerald Tuxedo",
    imageSrc:
      "https://i8.amplience.net/i/indochino/15011987_0_0.webp?w=312&sm=aspect&aspect=0.5693430656934306:1&qlt=100",
    link: "/suits-tuxedos/formal",
  },
  {
    id: 20,
      ...
      <div className=" h-[100px] lg:h-[250px] w-full m-auto relative group">
        ...
        <main className="mx-2 max-w-9xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pt-10 pb-6">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Formal Wear</h1>
          ...
          <section aria-labelledby="products-heading" className="pt-6 flex pb-24">
